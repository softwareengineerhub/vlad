...
Details:
    2) What is uniqueue ? equals() and hashCode() between its items;
    When HashSet for number, String - it is natural.

    When HashSet for Dog.
    What is  uniqueue for Dog ? --> Dog hashCode() and equals();
     */
    public static void main(String[] args) {
        ...
        System.out.println("contians A="+contains);
